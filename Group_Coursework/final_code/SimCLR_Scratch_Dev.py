...
from Models import ProjectionHead, ResNet
from Utilities import *
from torch.utils.data import DataLoader

######################################## DATASET #########################################

home = "/cs/student/projects1/dsml/2023/cdiezmar"
...
if __name__ == "__main__":
    ...
    if dataset_name == 'cifar10':
        ...
        batch_size = 750#256
        # num_classes = 1000
        print('Running: Downloading')
        # trainset_normal= datasets.INaturalist(root='/cs/student/projects1/dsml/2023/cdiezmar/datasets', version = '2021_train_mini',target_type = 'kingdom', transform=transform_normal)
        print('Done: Downloading')
        # trainloader_normal = DataLoader(trainset_normal, batch_size=batch_size, shuffle=False, num_workers=8)
        """imagenet_dataset_train = MixedINat(
            #root='/cs/student/projects1/dsml/2023/cdiezmar/datasets', #Dataset needs to be untared
            root='/cs/student/projects3/COMP0087/grp1/simclr_pytorch_new/datasets/iNat_kingdom', #Dataset needs to be untared
        ...
        batch_size = 300    
        dataset_train = MixedAnimalia("/cs/student/projects1/dsml/2023/cdiezmar/simclr_pytorch/datasets/ImagesAnimalia",transform=transform_augmented)
