...
def plot_features_video_sameimg(model, num_feats, all_labels, dataloader, epoch, val_df = None):
    ...
    plt.savefig(f'/cs/student/projects1/dsml/2023/cdiezmar/simclr_pytorch/figures/VideoSimCLR_training_sameimg_{epoch}.png') 
    plt.close()
...
def plot_features_video_next_frame(model, num_feats, all_labels, dataloader, epoch, val_df = None):
    ...
    plt.legend([str(i) for i in range(10)])
    plt.savefig(f'/cs/student/projects1/dsml/2023/cdiezmar/simclr_pytorch/figures/VideoSimCLR_training_diffimg_{epoch}.png') 
    plt.close()
...
if __name__ == "__main__":
    ...
    for epoch in range(epoch_number):
        ...
        if (epoch+1) % 5 == 0:
            # save_path = f'/cs/student/projects1/dsml/2023/cdiezmar/simclr_pytorch/models/checkpoints/{model_name}_{dataset_name}_{name}.pt'
            torch.save(resnet.state_dict(), save_path)
            # os.system("chmod -Rf 770 /cs/student/projects1/dsml/2023/cdiezmar/simclr_pytorch/models/")
    ...
    # save_path = f'/cs/student/projects1/dsml/2023/cdiezmar/simclr_pytorch/models/{model_name}_{dataset_name}_{name}.pt'
    torch.save(resnet.state_dict(), save_path)
